<?php
  ...
  // header("location:dashboard.php");
   ...
   $id = $_GET['id'];                            
    $qry1 = mysqli_query($db,"SELECT * from client where id ='$id'");        
    $d = mysqli_fetch_array($qry1);
    ...
    if(isset($_POST['update']))            
    {
        ...
        $sqll = "update Client set   clientname = '$a' ,orderno  = '$b' ,productcost = '$c' ,project = '$d' ,paymentmode = '$e' ,startdate = '$f' ,paymentstatus = '$g'   where id = '$id' ";
        $edit = mysqli_query($db,$sqll);
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" value="<?php echo $d['clientname']?>" class="form-control" id="exampleInputName1">
                        <?php 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="order" value="<?php echo $d['orderno']?>" class="form-control" id="exampleInputEmail3">
                        <?php 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="cost" value="<?php echo $d['productcost']?>" class="form-control" id="exampleInputPassword4" >
                        <?php 
                      ...
                      <div class="form-group">
                        ...
                        <select name="project" class="form-control" id="exampleSelectGender">
                          <option value="<?php echo $d['project']?>" selected hidden><?php echo $d['project']?></option>
                      ...
                      <div class="form-group">
                        ...
                        <option value="<?php echo $d['paymentmode']?>" selected hidden><?php echo $d['paymentmode']?></option>
                      ...
                      <div class="form-group">
                        ...
                        <input value="<?php echo $d['startdate']?>" type="date" name="date" class="form-control" placeholder="">
                        <?php 
                      ...
                      <div class="form-group">
                        ...
                        <option value="<?php echo $d['paymentstatus']?>" selected hidden><?php echo $d['paymentstatus']?></option>
